...
function HeroImage({ mobile = false }: { mobile?: boolean }) {
  return (
    <div className={`relative ${mobile ? "mx-auto h-[240px] w-[240px] sm:h-[280px] sm:w-[280px]" : "h-[360px] w-[360px] xl:h-[400px] xl:w-[400px]"}`}>
      <motion.div
      ...
      <motion.div
        className={`relative h-full w-full overflow-hidden border border-green-500/20 bg-gradient-to-br from-green-500/10 via-emerald-500/5 to-transparent shadow-[0_24px_80px_rgba(0,0,0,0.35)] ${mobile ? "rounded-[34px] p-3" : "rounded-[42px] p-4"}`}
        whileHover={{ scale: 1.03, y: -4 }}
        transition={{ type: "spring", stiffness: 220, damping: 24 }}
      >
        <div className={`relative h-full w-full overflow-hidden border border-white/10 bg-neutral-950/70 backdrop-blur-xl ${mobile ? "rounded-[24px]" : "rounded-[30px]"}`}>
          ...
          <Image
            ...
            fill
            priority
            className={mobile ? "object-contain p-4" : "object-contain p-6"}
            sizes={mobile ? "(max-width: 640px) 240px, 280px" : "(max-width: 1280px) 360px, 400px"}
          />
        </div>
      </motion.div>
    </div>
...
export default function Hero() {
  return (
    <section
      id="hero"
      className="relative flex min-h-screen w-full items-center justify-center overflow-hidden px-0 pt-14 sm:pt-20 lg:pt-24"
    >
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <ElegantShape
          ...
          className="left-[-24%] sm:left-[-10%] md:left-[-5%] top-[14%] md:top-[20%]"
        />
        <ElegantShape
          delay={0.5}
          width={400}
          ...
          className="right-[-22%] sm:right-[-5%] md:right-[0%] top-[58%] md:top-[65%]"
        />
        <ElegantShape
          delay={0.4}
          width={250}
          ...
          className="left-[-4%] md:left-[10%] bottom-[12%] md:bottom-[15%]"
        />
      </div>
        ...
        <div className="grid items-center gap-8 sm:gap-10 lg:grid-cols-2 lg:gap-8">
          ...
          >
            ...
            <motion.h2
              ...
              className="mb-4 text-xl text-neutral-300 sm:mb-5 sm:text-3xl lg:text-4xl"
            >
            ...
            <motion.p
              ...
              className="mx-auto mb-5 max-w-xl text-sm leading-7 text-neutral-400 sm:mb-6 sm:text-lg lg:mx-0"
            >
            ...
            <motion.p
              ...
              className="mx-auto mb-8 max-w-xl text-sm leading-7 text-neutral-500 lg:mx-0 sm:text-base sm:mb-10"
            >
