  ...
  return (
    <section className="py-16 sm:py-24 lg:py-32">
      <div className="container mx-auto px-4 sm:px-0">
        <div className="flex w-full flex-col justify-between gap-10 text-center lg:flex-row lg:items-start lg:text-left">
          <div className="flex w-full flex-col justify-between gap-6 items-center lg:items-start">
            ...
            <div className="flex items-center gap-2 justify-center lg:justify-start">
              <a href={logo.url} className="relative h-8 w-8">
                <Image
                  src={logo.src}
                  alt={logo.alt}
                  title={logo.title}
            ...
            <p className="max-w-sm text-sm leading-6 text-muted-foreground sm:max-w-md lg:max-w-[70%]">
              {description}
            </p>
          ...
          <div className="grid w-full gap-8 text-center sm:grid-cols-2 md:grid-cols-3 lg:gap-20 lg:text-left">
        ...
        <div className="mt-8 flex flex-col justify-between gap-4 border-t py-8 text-center text-xs font-medium text-muted-foreground md:flex-row md:items-center md:text-left">
